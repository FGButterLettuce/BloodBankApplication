...
var map = {
	...
	"./mobile-home/mobile-home.module": [
	...
	"./mobile-user-home/mobile-user-home.module": [
		"./src/app/mobile-user-home/mobile-user-home.module.ts",
		"mobile-user-home-mobile-user-home-module"
	],
	"./mobile-view-calendar/mobile-view-calendar/mobile-view-calendar.module": [
		"./src/app/mobile-view-calendar/mobile-view-calendar/mobile-view-calendar.module.ts",
		"default~mobile-view-calendar-mobile-view-calendar-mobile-view-calendar-module~user-mobile-schedule-m~cf86ad06",
		"common",
		"mobile-view-calendar-mobile-view-calendar-mobile-view-calendar-module"
	],
	...
	"./user/mobile-points/mobile-points.module": [
		"./src/app/user/mobile-points/mobile-points.module.ts",
		"user-mobile-points-mobile-points-module"
	],
	"./user/mobile-schedule/mobile-schedule.module": [
		"./src/app/user/mobile-schedule/mobile-schedule.module.ts",
		"default~mobile-view-calendar-mobile-view-calendar-mobile-view-calendar-module~user-mobile-schedule-m~cf86ad06",
		"common",
		"user-mobile-schedule-mobile-schedule-module"
	],
	"./user/points/points.module": [
		"./src/app/user/points/points.module.ts",
		"user-points-points-module"
	],
	"./user/schedule/schedule.module": [
		"./src/app/user/schedule/schedule.module.ts",
		"default~mobile-view-calendar-mobile-view-calendar-mobile-view-calendar-module~user-mobile-schedule-m~cf86ad06",
		"common",
		"user-schedule-schedule-module"
	],
	"./view-calendar/view-calendar/view-calendar.module": [
		"./src/app/view-calendar/view-calendar/view-calendar.module.ts",
		"default~mobile-view-calendar-mobile-view-calendar-mobile-view-calendar-module~user-mobile-schedule-m~cf86ad06",
		"common",
		"view-calendar-view-calendar-view-calendar-module"
	]
...
/* harmony import */ var _services_fcm_fcm_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/fcm/fcm.service */ "./src/app/services/fcm/fcm.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, router, fcm) {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _services_fcm_fcm_service__WEBPACK_IMPORTED_MODULE_6__["FcmService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _angular_fire_messaging__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/fire/messaging */ "./node_modules/@angular/fire/messaging/index.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var aws_amplify__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! aws-amplify */ "./node_modules/aws-amplify/lib/index.js");
/* harmony import */ var aws_amplify__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(aws_amplify__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var src_aws_exports_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/aws-exports.js */ "./src/aws-exports.js");
...
aws_amplify__WEBPACK_IMPORTED_MODULE_16___default.a.configure(src_aws_exports_js__WEBPACK_IMPORTED_MODULE_17__["default"]);
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], countup_js_angular2__WEBPACK_IMPORTED_MODULE_11__["CountUpModule"], aws_amplify_angular__WEBPACK_IMPORTED_MODULE_9__["AmplifyAngularModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].firebase),
                _angular_fire_messaging__WEBPACK_IMPORTED_MODULE_14__["AngularFireMessagingModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_13__["AngularFirestoreModule"]
            ],
            providers: [
...
var SessionService = /** @class */ (function () {
    function SessionService(amplifyService) {
    ...
    SessionService.prototype.clearall = function () {
        this.user = null;
        this.eid;
        this.pointsum = 0;
        this.pointobj = null;
    ...
    SessionService.prototype.getPoints = function (eid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.amplifyService.api().get('points', "/points/" + eid, {}).then(function (res) {
                            if (res && res.length > 0) {
                                _this.pointobj = res[0];
                                _this.pointobj.points.map(function (x) {
                                    _this.pointsum += x.point;
                                });
                            }
                            else
                                _this.pointobj = [];
    ...
    SessionService.prototype.getEvents = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.amplifyService.api().get('campaignsapi', "/campaigns", {}).then(function (res) {
                            if (res && res.length > 0) {
                                _this.eventsobj = res;
                            }
    ...
    SessionService.prototype.checkRecords = function (ueid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var records, _i, records_1, i;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.amplifyService.api().get('recordsapi', "/records", {}).then(function (res) {
                            if (res && res.length > 0) {
                                records = res;
                            }
                        }).catch(function (err) { return console.log(err); })];
    ...
    SessionService.prototype.getDonations = function (ueid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var donations, _i, donations_1, i;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.amplifyService.api().get('donationsapi', "/donations", {}).then(function (res) {
                            if (res && res.length > 0) {
                                donations = res;
                            }
                        }).catch(function (err) { return console.log(err); })];
    ...
    SessionService.prototype.getHospitals = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.amplifyService.api().get('hospitalsapi', "/hospitals", {}).then(function (res) {
                            if (res && res.length > 0) {
                                _this.hospitalsobj = res;
                            }
                        }).catch(function (err) { return console.log(err); })];
                    case 1:
                        _a.sent();
